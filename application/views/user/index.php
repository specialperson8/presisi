    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Halo, Selamat Datang <?= $user['nama']; ?></h1>
          ...
          <div class="card-body">
            ...
            <p class="card-text"><?= date('d F Y', $user['tanggal_dibuat']); ?></p>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Presisi Printing Sidoarjo <?= date('Y') ?> </span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
